...
class MonthsListSelected extends StatelessWidget {
  const MonthsListSelected({super.key, required this.months,});
  final List<MonthModel> months;

  @override
  Widget build(BuildContext context) {
    for (var month in months) {
      print("Month: ${month.name}, isSelected: ${month.isSelected}");
    }
    return  SizedBox(
      height: 100,
