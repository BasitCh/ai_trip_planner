...
class FloatingBottomNavBar extends StatelessWidget {
  ...
  const FloatingBottomNavBar({
    ...
    this.backgroundBlur = 20.5,
    this.borderRadius = 80,
    this.padding = const EdgeInsets.fromLTRB(10,15,6,15),
    this.outerPadding = const EdgeInsets.fromLTRB(15, 12, 15, 23),
    ...
    this.activeButtonFlexFactor = 70,
  ...
  /// Blur factor, from the [FloatingBottomNavBar]'s top
    ...
    for (final button in navigationBarButtons) {
      ...
      buttons.add(
        _Button(
          ...
          textStyle: theme.textTheme.bodyMedium!.copyWith(color: button.textColor,fontWeight: AppFontWeight.semiBold),
          icon: button.icon,
          ...
          activeFlexFactor: showActiveButtonText ? selectedIndex==1?activeButtonFlexFactor+40:activeButtonFlexFactor : 1,
          ...
          child: Padding(
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                color: backgroundGradient == null ? (backgroundColor ?? const Color(0x7d8c8c8c)).withOpacity(backgroundOpacity) : null,
...
class NavigationBarButton {
  /// Put this in [FloatingBottomNavBar]'s [navigationBarButtons]
  ///
  /// [ NavigationBarButton(...), NavigationBarButton(...), ... ]
  ...
  /// [FloatingBottomNavBar]'s [textStyle].
