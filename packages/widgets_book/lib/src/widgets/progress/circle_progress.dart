...
class DashedCircularProgressBar extends StatelessWidget {
  ...
  const DashedCircularProgressBar(
      {required this.width, required this.height, required this.radialGradient, super.key,
      this.progress = 0,
  ...
  const DashedCircularProgressBar.square(
      {required double dimensions, required this.radialGradient, super.key,
      this.progress = 0,
      this.maxProgress = 100,
      this.startAngle = 0,
      this.sweepAngle = 360,
  ...
  const DashedCircularProgressBar.aspectRatio(
      {required this.aspectRatio, required this.radialGradient, super.key,
      this.progress = 0,
      this.maxProgress = 100,
      this.startAngle = 0,
      this.sweepAngle = 360,
...
class _CircularProgressBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (seekSize > 0) {
      ...
      // Draw seek.
      canvas.drawArc(rect, startAngleRadian + sweepAngleRadian,
          circleSize + .02, false, circlePaint,);
    }
  }
