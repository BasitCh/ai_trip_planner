...
class ColorsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const colorItems = [
      _ColorItem(name: 'Secondary', color: AppColors.secondary1),
      _ColorItem(name: 'Black', color: AppColors.darkPurple),
      ...
      _ColorItem(name: 'Red Wine', color: AppColors.green),
      _ColorItem(name: 'Grey', color: AppColors.grey),
      _ColorItem(name: 'Liver', color: AppColors.green),
